...
func main() {
	...
	request := getItemsRequestv2{"perico"}

	payload, err := json.Marshal(request)
	if err != nil {
		fmt.Println("Error marshalling hackathon-scalefast-2020-hello-world request")
		os.Exit(0)
	}

	result, err := client.Invoke(&lambda.InvokeInput{FunctionName: aws.String("hackathon-scalefast-2020-hello-world"), Payload: payload})
	if err != nil {
		fmt.Println("Error calling hackathon-scalefast-2020-hello-world")
		os.Exit(0)
	}
	...
	if err != nil {
		log.Fatal(err)
		//fmt.Println("Error unmarshalling hackathon-scalefast-2020-hello-world response")
		os.Exit(0)
	}
